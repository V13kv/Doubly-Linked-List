...
enum class EXIT_CODES
{
    ...
    #define PRINT_VAR(object, objOutSpecifier)  printf("%s: " objOutSpecifier "\n", STRINGIFY(object), object);
    ...
    #define OBJECT_VERIFY(object, verifyFunction, dumpFunction)                                                 \
        do                                                                              \
        {                                                                               \
            if (!verifyFunction(object))                                                      \
            {                                                                           \
                dumpFunction(object);                                                     \
    ...
    #define VALUE_CODE_TO_STR(expression)
    #define STRINGIFY(object)
    #define PRINT_VAR(object, objOutSpecifier)
    #define EXIT_WITH_TRACE(funcExitCodeTracingMsg, programExitCode)
